// Copied from fflate v0.6.10 instead of export *, and removed fflate from dependency, because of issues with typescript moduleResolution. Update when fflate version is updated in three.js
/**
